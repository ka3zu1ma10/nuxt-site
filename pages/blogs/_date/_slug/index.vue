<template>
  <main class="page_wrap">
    <article class="blog">
      ...
      <div class="blog_body" v-html="bodyHtml" />
    </article>
  </main>
</template>
...
export default {
  ...
  validate({ params }) {
    return sourceFileArray.includes(
      `contents/blogs/md/${params.date}_${params.slug}.md`
    )
  },
  asyncData({ params }) {
    return Object.assign(
      {},
      require(`~/contents/blogs/json/${params.date}_${params.slug}.json`),
      { params }
    )
  },
  computed: {
    ...
    return {
      ...
      meta: [
        ...
        { hid: "og:title", property: "og:title", content: title },
        {
          hid: "og:image",
          property: "og:image",
          content: "https://ka-zu-ma.com/ogp/blog-" + blogId + ".png",
        },
      ],
